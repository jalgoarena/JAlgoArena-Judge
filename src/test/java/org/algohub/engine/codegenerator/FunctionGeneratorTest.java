...
public class FunctionGeneratorTest {
  ...
  static final Function TWO_SUM = new Function("twoSum",
  ...
  static final Function WORD_LADDER = new Function("ladderLength",
  ...
  @Test public void generateArrayIntDeclarationTest() {
  ...
  @Test public void generateComplexJavaTypeDeclarationTest() {
